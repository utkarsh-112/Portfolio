...
export const aboutData = {
  ...
  resume:
    'https://www.canva.com/design/DAEcx3NDJKw/KsOZQ7EVv2vUMNW2QrTDiA/view?utm_content=DAEcx3NDJKw&utm_campaign=designshare&utm_medium=link&utm_source=publishsharelink', // if no resume, the button will not show up
};
...
export const projectsData = [
  {
    ...
    info:
      'This is a website to create your desired gradients or color styles which you require to make your website more attractive. You can choose and copy the color codes in RGB if you like any of the combination.',
    info2: '',
  ...
  },
  {
    ...
    info:
      'This is a highly interative app that i developed using React which displays different robots with corresponding names and emails',
    info2: '',
  ...
  },
  {
    ...
    info:
      'This is a simple game purely based on HTML5, CSS3 and javascript. A random number is generated each time we play the game and we have to guess the number in the minimum guesses possible to win.',
    info2: '',
  ...
  },
  {
    ...
    title: 'Roll the Dice',
    info:
      'This is a multiplayer game where two players can play at once. Player has to start the game by clicking on roll dice. First player to reach 100 score wins, but if player draws 1 score resets to zero.',
    info2: '',
  ...
  },
  {
    id: nanoid(),
    img: 'project7.png',
    title: 'Ntours | Book nature tours',
    info:
      'This is a website showcasing the power of SASS with all the advanced CSS features. This shows that CSS alone can be a very powerful tool.',
    info2: '',
    url: 'https://utkarsh-112.github.io/Ntours.github.io/',
    repo: 'https://github.com/utkarsh-112/Ntours.github.io', // if no repo, the button will not show up
  },
  {
    id: nanoid(),
    img: 'project8.png',
    title: 'SmartAI | Find anyone just by their face',
    info:
      'This is a web app that uses node js as backend and mongoDB database to store real time user details. This website offers face detection services to its users.',
    info2: '',
    url: 'https://smartai-app.herokuapp.com/',
    repo: 'https://github.com/utkarsh-112/SmartAI-Backend', // if no repo, the button will not show up
  },
];
